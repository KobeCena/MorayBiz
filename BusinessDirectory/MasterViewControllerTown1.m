...
#import "MasterViewControllerTown1.h"
#import "sqlite3.h"

@implementation MasterViewControllerTown1
@synthesize detailViewController = _detailViewController;
@synthesize arrayAppro;
...
- (void)initializeBusData
{
    ...
    if(sqlite3_open([defaultDBPath UTF8String], &database) == SQLITE_OK) {
        ...
        NSString *sqlStatement1 = [NSString stringWithFormat:@"SELECT * FROM TBL_BUSINESS_MAIN WHERE BUS_Town = '%@';", [def objectForKey:@"TownChoice"]];
...
{
    [[NSUserDefaults standardUserDefaults] setValue:[sortedArray objectAtIndex:indexPath.row] forKey:@"TownChoiceDetail"];
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone)
    {
        [self performSegueWithIdentifier:@"TownDetailPush" sender:self];
