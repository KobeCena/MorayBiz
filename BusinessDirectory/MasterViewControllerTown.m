...
#import "MasterViewControllerTown.h"
#import "sqlite3.h"

@implementation MasterViewControllerTown
...
- (void)initializeBusData
{
    ...
    if (sqlite3_open(dbpath, &db) == SQLITE_OK)
    {
        ...
        if (sqlite3_prepare_v2(db, query_stmt, -1, &statement, NULL) == SQLITE_OK)
        {
            ...
            NSString *BusTown = [[NSString alloc] initWithUTF8String:(const char *) sqlite3_column_text(statement, 2)];
...
{
    [def setObject:[sortedArray objectAtIndex:indexPath.row] forKey:@"TownChoice"];
    [self performSegueWithIdentifier:@"TownFirstPush" sender:self];
}
