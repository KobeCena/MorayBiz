...
#import "MapsWebViewControllerTown.h"

@interface MapsWebViewControllerTown ()

@end

@implementation MapsWebViewControllerTown
...
{
    UIAlertView *al = [[UIAlertView alloc] initWithTitle:[def objectForKey:@"finalStringTown"] message:@"HAPPY?" delegate:self cancelButtonTitle:@"dismiss" otherButtonTitles:nil];
    [al show];
}
...
- (void)viewDidLoad
{
    ...
    NSURL *finalURL = [NSURL URLWithString:[def objectForKey:@"finalStringTown"]];
