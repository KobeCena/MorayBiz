...
#import "WebBrowserViewControllerCat.h"

@interface WebBrowserViewControllerCat ()

@end

@implementation WebBrowserViewControllerCat
...
- (void)viewDidLoad
{
    ...
    NSURL *finalURL = [NSURL URLWithString:[def objectForKey:@"webStringCat"]];
