...
#import "MapsWebViewControllerCat.h"

@interface MapsWebViewControllerCat ()

@end

@implementation MapsWebViewControllerCat
...
{
    UIAlertView *al = [[UIAlertView alloc] initWithTitle:[def objectForKey:@"finalStringCat"] message:@"HAPPY?" delegate:self cancelButtonTitle:@"dismiss" otherButtonTitles:nil];
    [al show];
}
...
- (void)viewDidLoad
{
    ...
    NSURL *finalURL = [NSURL URLWithString:[def objectForKey:@"finalStringCat"]];
