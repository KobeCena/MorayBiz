//
//  BusDetailsViewControllerTown.m
//  BusinessDirectory
//
...
#import "BusDetailsViewControllerTown.h"
#import "sqlite3.h"
#import <MessageUI/MFMailComposeViewController.h>

@interface BusDetailsViewControllerTown ()

@end

@implementation BusDetailsViewControllerTown
@synthesize navItem;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        def = [NSUserDefaults standardUserDefaults];
        [def setObject:selected forKey:@"webStringTown"];
        [self performSegueWithIdentifier:@"webModalTown" sender:self];
    }
    ...
    if (selected == fullBusAddr)
    {
        ...
        def = [NSUserDefaults standardUserDefaults];
        [def setObject:finalString forKey:@"finalStringTown"];
        [self performSegueWithIdentifier:@"mapsModalTown" sender:self];
    }
